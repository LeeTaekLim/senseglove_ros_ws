...
{
  // if (i/4 == 1){
  // std::cout << "hand_pose_.handAngles[std::floor" << i / 4 << i % 4 << ".x : " << hand_pose_.handAngles[std::floor(i / 4)][i % 4].x << std::endl;
  // std::cout << "hand_pose_.handAngles[std::floor" << i / 4 << i % 4 << ".y : " << hand_pose_.handAngles[std::floor(i / 4)][i % 4].y << std::endl;
  // std::cout << "hand_pose_.handAngles[std::floor" << i / 4 << i % 4 << ".z : " << hand_pose_.handAngles[std::floor(i / 4)][i % 4].z << std::endl;
  // }
